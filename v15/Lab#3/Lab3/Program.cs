...
namespace Lab3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Введiть число яке хочете занести на початок двозв'язного кiльцевого списку: ");
            count = Int32.Parse(Console.ReadLine());
            AddElementInStartOfList(numbers, count);
            PrintList(numbers);
            Console.WriteLine("----------------------------------------------");

            Console.Write("Введiть число яке хочете занести в кiнець двозв'язного кiльцевого списку: ");
            count = Int32.Parse(Console.ReadLine());
        ...
        //Видаляємо елемент з двозв'язного кільцевий списку по індексу
        ...
        //Вставляємо елемент в двоозв'язний кільцевий список по індексу
        ...
        //Додаємо елемент в кінець двозв'язного кільцевий списку
        ...
        //Додаємо елемент на початок двозв'язного кільцевий списку
