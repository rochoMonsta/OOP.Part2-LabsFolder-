...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Arc> inputArcs = new List<Arc>();
        ...
        public static void InputArc(List<Arc> arcs, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                arcs.Add(new Arc(x_degree, y_degree));
            }
        }
        public static void PrintArray(List<Arc> arcs, int count)
        {
            for (int i = 0; i < count; ++i)
