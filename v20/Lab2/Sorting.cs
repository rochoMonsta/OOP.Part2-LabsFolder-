...
namespace Lab1
{
    ...
    {
        //Сортування вставкою
        public void InsertionSort(List<Stone> stones)
        {
            int i, j;
        ...
        private void Merge(List<Stone> array, int lowIndex, int middleIndex, int highIndex)
        {
            var left = lowIndex;
        ...
        //сортування злиттям
        public void MergeSort(List<Stone> array, int lowIndex, int highIndex)
        {
